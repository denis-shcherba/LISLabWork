...
def basic_geometry():
    ...
    middle_piece1 = union()(
            translate((0, -6.2, 0))(				#actually       y_translation_bigpiece_1+np.sin(60)*np.pi/180
            rotate((0, 0 ,0))(
    ...
    return union()(big_piece1, big_piece2, big_piece3, small_piece1, small_piece2, small_piece3, middle_piece1,small_middlepiece1, small_middlepiece2, small_middlepiece3)
