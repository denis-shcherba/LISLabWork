#include <rai/KOMO/komo.h>
#include <rai/KOMO/skeleton.h>
#include <string>
#include <map>
#include <rai/Core/graph.h>
#include <rai/Kin/switch.h>
#include <rai/Kin/viewer.h>
#include <rai/KOMO/manipTools.h>
...
void testPivot(){
  ...
  for(uint i=0;i<20;i++){
    ...
    seq.komo->addObjective({2.}, FS_qItself, {"hinge_joint"}, OT_eq, {1e1}, rand(1));
